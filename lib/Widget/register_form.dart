...
class RegisterForm extends StatefulWidget {
  ...
  RegisterForm({required this.children});
...
class _RegisterFormState extends State<RegisterForm> {
  ...
  static Map<String, dynamic> dataInput = {
  ...
  static Column buildFutureSelection<Model>({
  ...
  static Column buildInput(String label, Widget inputField) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Padding(
  ...
  static Container buildTextFormField(
    String label,
    String form_key,
    {Widget ?prefixIcon,
